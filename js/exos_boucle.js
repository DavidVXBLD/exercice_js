...
console.log("\n# Exercice 7#\n");
 ...
 for (var infos in citizen) {
  if (infos === "sexe") {
    if (citizen[infos]) {
      console.log(infos + " : female");
    }
    else {
      console.log(infos + " : male");
    }
  }
  else {
  console.log(infos + " : " + citizen[infos]);
  }
 }

 console.log("\n# Exercice 9#\n");
 //Exercice 9)_________________________________________________________________________________________________________________________________________
